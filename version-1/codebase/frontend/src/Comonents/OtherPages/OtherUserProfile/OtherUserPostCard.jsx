...
const OtherUserPostCard = ({ userName, userId }) => {
...
//   }, [dispatch]);
  ...
  return (
    <>
      ...
      {/* First Data */}
      {otherUserData && otherUserData?.posts?.length > 0 &&
              ...
              <div className="bg-white rounded-lg shadow-[0_2px_6px_rgba(0,0,0,0.10)] p-5 mb-4">
                ...
                <div className="flex items-center justify-between space-x-4 mb-1 pb-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center">
                          {post?.user_id !== userDetails?.id ? (
                            <>
                              <Link
                                to={`/profile/${post?.user_name}/${post?.user_id}`}
                              >
                  ...
                  <div
                    ...
                    onClick={() => showBlockReport(post?.id)}
                  >
                    <img
                      src={dotThree}
                      alt="dotThree"
